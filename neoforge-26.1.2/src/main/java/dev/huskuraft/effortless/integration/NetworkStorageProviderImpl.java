    ...
    private static final class Ae2Storage {
        ...
        private record TerminalAccess(
            ...
            MEStorage inventory(net.minecraft.world.entity.player.Player player) {
                ...
                // A menu host can expose a null/empty cache until its menu
                // starts ticking. The linked grid is the authoritative
                // fallback and is also used for Curios terminals off-menu.
                return null;
            }
        }
    }
