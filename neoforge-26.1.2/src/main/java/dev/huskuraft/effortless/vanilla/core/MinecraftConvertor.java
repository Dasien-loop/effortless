...
public final class MinecraftConvertor {
    ...
    public static InteractionResult fromPlatformInteractionResult(net.minecraft.world.InteractionResult interactionResult) {
        if (interactionResult == net.minecraft.world.InteractionResult.SUCCESS
                || interactionResult == net.minecraft.world.InteractionResult.SUCCESS_SERVER) {
            return InteractionResult.SUCCESS;
        }
        if (interactionResult == net.minecraft.world.InteractionResult.CONSUME) return InteractionResult.CONSUME;
        if (interactionResult == net.minecraft.world.InteractionResult.PASS) return InteractionResult.PASS;
        if (interactionResult == net.minecraft.world.InteractionResult.FAIL) return InteractionResult.FAIL;
