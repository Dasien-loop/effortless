...
public class ForgeCommonEventRegistry extends CommonEventRegistry {
    ...
    public void onCommonSetup(FMLCommonSetupEvent event) {
        // Forge locks network channel registration before the first player logs in.
        // Initialize the platform channel during common setup instead of on first send.
        var networking = PlatformLoader.getSingleton(Networking.class);
        networking.registerServerReceiver(Effortless.getInstance().getChannel()::receiveBuffer);
